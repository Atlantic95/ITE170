...
var h = canvas1.height = canvas2.height = canvas3.height = document.body.scrollHeight;
window.addEventListener('resize', function() {
  w = canvas1.width = canvas2.width = canvas3.width = window.innerWidth;
  h = canvas1.height = canvas2.height = canvas3.height = document.body.scrollHeight;
});
